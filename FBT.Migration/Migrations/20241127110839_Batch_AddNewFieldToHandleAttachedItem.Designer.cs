...
namespace FBT.Migration.Migrations
{
    ...
    [Migration("20241127110839_Batch_AddNewFieldToHandleAttachedItem")]
    partial class Batch_AddNewFieldToHandleAttachedItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FBT.Domain.Models.Package", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DataKey")
                        .HasDatabaseName("IX_Packages_DataKey");

                    b.ToTable("Packages", "dbo");
                });

            modelBuilder.Entity("FBT.Domain.Models.PackageAttachProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AttachProductCode")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("DataKey")
                        .HasDatabaseName("IX_PackageAttachProducts_DataKey");

                    b.HasIndex("PackageId");

                    b.ToTable("PackageAttachProducts", "dbo");
                });
            ...
            modelBuilder.Entity("FBT.ShareModels.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DataKey")
                        .HasDatabaseName("IX_Categories_DataKey");
            ...
            modelBuilder.Entity("FBT.ShareModels.Entities.OrderReturnItem", b =>
                {
                    ...
                    b.HasIndex("DataKey")
                        .HasDatabaseName("IX_OrderReturnItems_DataKey");

                    b.HasIndex("OrderHeaderId");

                    b.ToTable("OrderReturnItems", "dbo");
                });
            ...
            modelBuilder.Entity("FBT.ShareModels.Entities.WarehouseUserSetting", b =>
                {
                    ...
                    b.HasIndex("DataKey")
                        .HasDatabaseName("IX_WarehouseUserSettings_DataKey");

                    b.ToTable("WarehouseUserSettings", "dbo");
                });
            ...
            modelBuilder.Entity("FBT.Domain.Models.PackageAttachProduct", b =>
                {
                    b.HasOne("FBT.Domain.Models.Package", "Package")
                        .WithMany("PackageAttachProducts")
            ...
            modelBuilder.Entity("FBT.Domain.Models.Package", b =>
                {
                    b.Navigation("PackageAttachProducts");
                });
